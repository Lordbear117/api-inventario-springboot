...
@Tag(name = "Endpoints de Categorias", description = "CRUD de Invenario de Productos Electronicos")
@RestController
...
public class CategoryController {
    ...
    public void update(@PathVariable long categoryId, @Valid @RequestBody UpdateCategoryDTO data)
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void delete(@PathVariable long categoryId) throws CategoryNotFoundException {
